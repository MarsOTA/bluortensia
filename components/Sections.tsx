...
export function AtmosphereGrid() {
  const scenes = [
    [brandAssets.heroDesktop, "Ombrellone macramè Mirto BluOrtensia per beach club con lettini e atmosfera mediterranea", "Beach club", "File di ombrelloni che diventano una firma visiva", "Una spiaggia ordinata, luminosa, riconoscibile già da una foto dall'alto: il crochet ammorbidisce le linee e rende premium anche la zona lettini."],
    [brandAssets.hotelPool, brandAltText.hotelPool, "Hotel pool", "Piscine e resort con un dettaglio memorabile", "Accanto ad acqua, pietra chiara e tessili naturali, l'ombrellone BluOrtensia crea ombra filtrata e una quinta elegante per ospiti e contenuti social."],
    [brandAssets.productMirto, "Ombrellone macramè Mirto su terrazza privata mediterranea con lavorazione artigianale", "Villa terrace", "Terrazze private con atmosfera da estate italiana", "Per ville al mare, patii e bordi piscina: una presenza leggera, artigianale, pensata per dialogare con lino, cotto, ulivi e bouganville."],
    [brandAssets.restaurant, brandAltText.restaurant, "Restaurant dehors", "Tavoli vista mare più intimi e fotografabili", "Il dehors acquista calore senza appesantirsi: frange, nodi e trama aperta creano un segno riconoscibile durante pranzo, aperitivo e cena."],
  ];
